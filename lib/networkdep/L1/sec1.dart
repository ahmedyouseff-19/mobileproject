...
class network1sec extends StatefulWidget {
  const network1sec({Key? key}) : super(key: key);

  @override
  _network1secState createState() => _network1secState();
}

class _network1secState extends State<network1sec> {
  @override
